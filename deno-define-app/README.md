# Define term application

This project crowd sources company definitions for acronyms and terms. It allows users to look up and add new definitions. 
...
$ slack create my-app -t slack-samples/deno-define-app
